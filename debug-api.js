    ...
    res.on('end', () => {
        try {
            ...
            if (json.matches && json.matches.length > 0) {
                console.log("First match competition:", json.matches[0].competition.name, json.matches[0].competition.id);
                ...
                if (filtered.length > 0) {
                    console.log("Sample interested match:", filtered[0].homeTeam.name, "vs", filtered[0].awayTeam.name);
                }
            } else {
